...
BEGIN
    OPEN FUNCTIONS_AND_PROCEDURES_NAMES;
    FETCH FUNCTIONS_AND_PROCEDURES_NAMES INTO TMP, TMP1;
    CLOSE FUNCTIONS_AND_PROCEDURES_NAMES;
    DBMS_OUTPUT.PUT_LINE('HERE!' || TMP);
    DBMS_OUTPUT.PUT_LINE('HEREFF!' || TMP1);

    FOR RECORD IN FUNCTIONS_AND_PROCEDURES_NAMES
        LOOP
            DBMS_OUTPUT.PUT_LINE('IN LOOP' || RECORD.DEVELOPER_FUNCTION_OR_PROCEDURE_NAME);
        END LOOP;
...
BEGIN
    CHECK_FUNCTIONS_OR_PROCEDURES('DEVELOPER', 'PRODUCTOR', 'FUNCTION');
END;
