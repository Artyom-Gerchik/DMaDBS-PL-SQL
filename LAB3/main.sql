...
CREATE OR REPLACE PROCEDURE CHECK_FUNCTIONS_AND_PROCEDURES(DEV_SCHEMA_NAME VARCHAR2, PROD_SCHEMA_NAME VARCHAR2,
    ...
    FOR RECORD IN FUNCTIONS_AND_PROCEDURES_NAMES
        LOOP
            ...
            IF RECORD.DEVELOPER_NAME IS NULL THEN
                DBMS_OUTPUT.PUT_LINE('DROP ' || TYPE_TO_CHECK || ' '
                    || RECORD.PRODUCTOR_NAME || ';');
                CONTINUE;
            END IF;
        END LOOP;
END CHECK_FUNCTIONS_AND_PROCEDURES;
...
BEGIN
    ...
    CHECK_FUNCTIONS_AND_PROCEDURES(DEV_SCHEMA_NAME, PROD_SCHEMA_NAME, 'FUNCTION');
END;
