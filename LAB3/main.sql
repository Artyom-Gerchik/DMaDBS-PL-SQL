    ...
    FOR RECORD IN FUNCTIONS_AND_PROCEDURES_NAMES
        LOOP
            ...
            IF RECORD.PRODUCTOR_FUNCTION_OR_PROCEDURE_NAME IS NULL OR
               GET_FUNCTION_OR_PROCEDURE_TEXT(DEV_SCHEMA_NAME, TYPE_TO_CHECK, RECORD.DEVELOPER_FUNCTION_OR_PROCEDURE_NAME)
                   !=
               GET_FUNCTION_OR_PROCEDURE_TEXT(PROD_SCHEMA_NAME, TYPE_TO_CHECK, RECORD.PRODUCTOR_FUNCTION_OR_PROCEDURE_NAME)
            THEN
